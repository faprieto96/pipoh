...
class fnc_WUBC(ABC):
    ...
    def __init__(self, name='Weighted upper Bound Constraint, WUBC', lamb=1, delta=1, upper_bound=1, lower_bound=0, validation_windows=36, cv_windows=12) -> None:
        self.name = name
        self.lamb = lamb
        self.delta = delta
    ...
    def solve_optimization_problem(self):
        ...
        UB = (np.ones((1, N))* upperBoundValue)[0]
